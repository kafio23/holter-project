...
urlpatterns = (
    ...
    path('patient/<int:patient_id>/upload1/', views.patient_upload, name='url_patient_upload'),
    path('patient/<int:patient_id>/upload/', views.signal_upload, name='url_signal_upload'),
